...
const footer = () => {
  return (
    <section className="py-12 bg-[#F5F5F3] mt-36">
      <div className="container">
        <div className="grid md:grid-cols-2">
          <div className="grid grid-cols-2 md:grid-cols-3 gap-y-8 md:gap-y-0 ">
            <div>
              <h4 className="font-bold text-base leading-6 text-heading pb-2">
                Menu
              </h4>
              <ul>
                <li>
                  <Link
                    className="font-normal text-base leading-4 text-paragraph"
                    href="/"
                  >
                    Home
                  </Link>
          ...
          <div className="grid grid-cols-2 pt-8 md:mt-0">
            <div className="">
              <h4 className="font-bold text-base leading-6 text-heading pb-2">
                (052) 611-5711 <span className="block">company@domain.com</span>
              </h4>
              <p className="font-normal text-base leading-4 text-paragraph">
        ...
        <div className="grid md:grid-cols-2 pt-16">
          <div>
            <p className="flex gap-4 items-cfillRule=enter justify-center md:justify-start">
              <Link href="/">
                <svg
                  width="9"
                  height="16"
          ...
          <div className="text-center md:text-right">
            <p className="font-normal leading-6 text-base text-paragraph pt-6 md:pt-0">
              <span id="years"></span> Orebi Minimal eCommerce Figma Template by
              Adveits
            </p>
          </div>
        </div>
