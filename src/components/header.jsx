...
const Navbar = () => {
  return (
    <>
      <nav className="font-dmsans text-base">
        <div className="py-8 bg-white">
          <div className="container grid gap-4 md:gap-0 md:grid-cols-[auto_1fr_auto] grid-cols-[1fr_auto_auto] items-center">
            {/* Logo */}
            ...
            {/* main menu */}
            <div className="font-dmsans text-base hidden md:block">
              <ul className="flex gap-10 items-center justify-center">
                <li>
                  <Link
                    className="text-[#767676] hover:text-[#262626] transition-all"
                    to="/"
                  >
                    Home
                  </Link>
            ...
            <div className="flex gap-2">
              <button className="border-none text-[#767676] hover:text-[#262626] transition-all uppercase">
                EN
              </button>
              <button className="border-none text-[#767676] hover:text-[#262626] transition-all uppercase">
                RU
        ...
        <div className="bg-[#F5F5F3] py-6 rounded-md">
          <div className="container grid grid-rows-2 md:grid-rows-1 grid-cols-2 md:grid-cols-3 items-center ">
            {/* Shop by category */}
            <div className="flex items-center gap-2 ">
              <button>
                <svg
            ...
            <form
              action="#"
              className=" bg-white px-4 py-3 col-span-2 md:col-span-1 row-start-2 md:row-span-1"
            >
              <div className="grid grid-cols-[1fr_30px] items-center">
                <input
                  className="focus:outline-none focus:border-none leading-6"
                  type="search"
            ...
            <div className="flex items-center gap-6  justify-end">
              <button className="group relative border-none flex gap-3 items-center">
                <svg
                  width="14"
                  height="16"
                  viewBox="0 0 14 16"
                ...
                <ul className="w-[200px] absolute z-20 right-0 top-full mt-2 opacity-0 group-hover:opacity-100 transition-all">
                  <li>
                    <Link
                      className="block text-center hover:text-black hover:bg-transparent py-4 bg-black text-white"
                      to="#"
                    >
                      My Account
                    </Link>
